...
const navGroups: NavItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: '/html-entity', label: 'HTML实体编码', icon: <Code size={16} /> },
    ],
  },
  {
    label: '开发工具',
  ...
  },
  {
    ...
    children: [
      ...
      { path: '/flexbox', label: 'CSS Flexbox', icon: <Columns size={16} /> },
      { path: '/transform', label: 'CSS Transform', icon: <RotateCw size={16} /> },
  ...
  },
  {
    ...
    children: [
      ...
      { path: '/url-parser', label: 'URL解析', icon: <Globe size={16} /> },
